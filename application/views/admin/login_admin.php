...
<div class="col-md-3 grid-margin stretch-card card-primary" style="margin-top: 150px; margin-right: auto; margin-left: auto;">
              <div class="card">
                <div class="card-body">
                  <h4 style= "float:right" class="card-title">Login Admin</h4>
                  ...
                  <a class="text-right" href="<?= base_url('auth') ?>">Login Users</a>
                </div>
              </div>
            </div>